...
/////////////////////////////////////////////////////////////////////////////
// CGdipButton
BOOL CGdipButton::m_bFlag = FALSE;
...
void CGdipButton::OnLButtonDown(UINT nFlags, CPoint point)
{
	...
	if (NULL != this->m_pDriverCtrl)
	{
		strWindowId.Format("%d",this->m_pDriverCtrl->m_curWndIndex);
		
		if (this->m_pDriverCtrl->m_mapFactory.Lookup(strWindowId, pParam))
		{
			LOG4CXX_INFO(this->m_pDriverCtrl->logger,"this->m_pDriverCtrl = " <<this->m_pDriverCtrl->m_curWndIndex);
			if (NULL != pParam && (0 == strncmp(pParam->deviceType,"HK",2)))
			{
				switch(m_type)
				{
				case 1://左上
					pParam->pDriverAdaptorPat->CloudPatControl(25,0,5);
					break;
				case 2://右上
					pParam->pDriverAdaptorPat->CloudPatControl(26,0,5);
					break;
				case 3://左下
					pParam->pDriverAdaptorPat->CloudPatControl(27,0,5);
					break;
				case 4://右下
					pParam->pDriverAdaptorPat->CloudPatControl(28,0,5);
					break;
				case 5://上
					pParam->pDriverAdaptorPat->CloudPatControl(21,0,5);
					break;
				case 6://下
					pParam->pDriverAdaptorPat->CloudPatControl(22,0,5);
					break;
				case 7://左
					pParam->pDriverAdaptorPat->CloudPatControl(23,0,5);
					break;
				case 8://右
					pParam->pDriverAdaptorPat->CloudPatControl(24,0,5);
					break;
				default:
					break;
				}
			}
			else if(0 == strncmp(pParam->deviceType,"DH",2))
			{
				switch(m_type)
				{
				case 1://左上
					pParam->pDriverAdaptorPat->CloudPatControl(32,0,5);
					break;
				case 2://右上
					pParam->pDriverAdaptorPat->CloudPatControl(33,0,5);
					break;
				case 3://左下
					pParam->pDriverAdaptorPat->CloudPatControl(34,0,5);
					break;
				case 4://右下
					pParam->pDriverAdaptorPat->CloudPatControl(35,0,5);
					break;
				case 5://上
					pParam->pDriverAdaptorPat->CloudPatControl(0,0,5);
					break;
				case 6://下
					pParam->pDriverAdaptorPat->CloudPatControl(1,0,5);
					break;
				case 7://左
					pParam->pDriverAdaptorPat->CloudPatControl(2,0,5);
					break;
				case 8://右
					pParam->pDriverAdaptorPat->CloudPatControl(3,0,5);
					break;
				default:
					break;
				}
...
void CGdipButton::OnLButtonUp(UINT nFlags, CPoint point)
{
	...
	if (NULL != this->m_pDriverCtrl)
	{
		CString strWindowId = "";
		strWindowId.Format("%d",this->m_pDriverCtrl->m_curWndIndex);
		LOG4CXX_INFO(this->m_pDriverCtrl->logger,"this->m_pDriverCtrlUp = " <<this->m_pDriverCtrl->m_curWndIndex);
		if (this->m_pDriverCtrl->m_mapFactory.Lookup(strWindowId, pParam))
		{
			if (0 == strncmp(pParam->deviceType,"HK",2))
			{
				switch(m_type)
				{
				case 1://左上
					pParam->pDriverAdaptorPat->CloudPatControl(25,1,5);
					break;
				case 2://右上
					pParam->pDriverAdaptorPat->CloudPatControl(26,1,5);
					break;
				case 3://左下
					pParam->pDriverAdaptorPat->CloudPatControl(27,1,5);
					break;
				case 4://右下
					pParam->pDriverAdaptorPat->CloudPatControl(28,1,5);
					break;
				case 5://上
					pParam->pDriverAdaptorPat->CloudPatControl(21,1,5);
					break;
				case 6://下
					pParam->pDriverAdaptorPat->CloudPatControl(22,1,5);
					break;
				case 7://左
					pParam->pDriverAdaptorPat->CloudPatControl(23,1,5);
					break;
				case 8://右
					pParam->pDriverAdaptorPat->CloudPatControl(24,1,5);
					break;
				default:
					break;
				}
			...
			else if(0 == strncmp(pParam->deviceType,"DH",2))
			{
				...
				{
				case 1://左上
					pParam->pDriverAdaptorPat->CloudPatControl(32,1,5);
					break;
				case 2://右上
					pParam->pDriverAdaptorPat->CloudPatControl(33,1,5);
					break;
				case 3://左下
					pParam->pDriverAdaptorPat->CloudPatControl(34,1,5);
					break;
				case 4://右下
					pParam->pDriverAdaptorPat->CloudPatControl(35,1,5);
					break;
				case 5://上
					pParam->pDriverAdaptorPat->CloudPatControl(0,1,5);
					break;
				case 6://下
					pParam->pDriverAdaptorPat->CloudPatControl(1,1,5);
					break;
				case 7://左
					pParam->pDriverAdaptorPat->CloudPatControl(2,1,5);
					break;
				case 8://右
					pParam->pDriverAdaptorPat->CloudPatControl(3,1,5);
					break;
				default:
					break;
				}
